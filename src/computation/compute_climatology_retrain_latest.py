#!/usr/bin/env python
"""
Compute climatology (mean across time) for LUCIE 10yr retrain_latest data
...
print("="*80)
print("LUCIE 10yr Retrain Latest - Computing Climatology (Memory-Optimized)")
print("="*80)

samples_dir = "/glade/derecho/scratch/mdarman/lucie/results/unet_final_v10/samples_lucie_10yr_retrain_latest"
