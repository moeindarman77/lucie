...
def sample(model, scheduler, train_config, diffusion_model_config,
    ...
    xt = torch.randn_like(fno_output).to(device)
    # T = 500
...
def infer(args):
    ...
    checkpoint_path = '/glade/derecho/scratch/mdarman/lucie/results/unet_simple_v4_reproduce/checkpoints/best_ldm.pth'
    ...
    with torch.no_grad():
        ...
        for cond_data_index in range(1, len(dataset)):
