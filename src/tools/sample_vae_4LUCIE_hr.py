...
def infer(args):
    ...
    load_dir = '/glade/derecho/scratch/mdarman/lucie/results/vae_hr/checkpoints/vae_autoencoder_ckpt_epoch_15.pth'
    ...
    with torch.no_grad():
        for data in data_loader:
            ...
            decoded_output, _ = model(hres, lsm_expanded)
            ...
            lucie_zero_shot, _ = model(hres, lsm_expanded)
