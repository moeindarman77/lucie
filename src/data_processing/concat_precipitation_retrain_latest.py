#!/usr/bin/env python
"""
Concatenate all precipitation samples from LUCIE 10yr retrained (LATEST) model
...
print("="*80)
print("LUCIE 10yr - Concatenating Precipitation Samples (Latest Retrained Model)")
print("="*80)
