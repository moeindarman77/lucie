...
data_to_plot = [
    ...
    # (means['fno_output'][1], "FNO", loncoords_hres, latcoords_hres),
    (means['output'][1], "Model Output", loncoords_hres, latcoords_hres),
...
data_to_plot = [
    ...
    # (means['fno_output'][3]*1000, "FNO", loncoords_hres, latcoords_hres),
    (means['output'][3]*1000, "Model Output", loncoords_hres, latcoords_hres),
...
# fno_u_mean, fno_u_std = compute_mean_std_spectrum_torch(torch.tensor(means['fno_output'][1]).unsqueeze(0))
...
# fno_v_mean, fno_v_std = compute_mean_std_spectrum_torch(torch.tensor(means['fno_output'][2]).unsqueeze(0))
...
# fno_precip_mean, fno_precip_std = compute_mean_std_spectrum_torch(torch.tensor(means['fno_output'][3]).unsqueeze(0))
...
for channel, metric_name in enumerate(["Temperature", 
                                    #    "SpecificHumidity",
                                         "U-Wind", "V-Wind", "Precipitation"]):
