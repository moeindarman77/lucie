...
data_to_plot = [
    ...
    (means['lres_interp'][1]*1000, "Bicubic interp.", loncoords_hres, latcoords_hres),
...
data_to_plot = [
    ...
    (means['fno_output'][2], "FNO", loncoords_hres, latcoords_hres),
...
data_to_plot = [
    ...
    (means['fno_output'][3], "FNO", loncoords_hres, latcoords_hres),
...
data_to_plot = [
    ...
    (means['fno_output'][4]*1000, "FNO", loncoords_hres, latcoords_hres),
...
data_to_plot = [
    ...
    (means['lres_interp'][5], "Bicubic interp.", loncoords_hres, latcoords_hres),
    (means['fno_output'][5], "FNO", loncoords_hres, latcoords_hres),
...
fno_shum_mean, fno_shum_std = compute_mean_std_spectrum_torch(torch.tensor(means['fno_output'][1]).unsqueeze(0))
...
fno_u_mean, fno_u_std = compute_mean_std_spectrum_torch(torch.tensor(means['fno_output'][2]).unsqueeze(0))
...
fno_v_mean, fno_v_std = compute_mean_std_spectrum_torch(torch.tensor(means['fno_output'][3]).unsqueeze(0))
...
fno_precip_mean, fno_precip_std = compute_mean_std_spectrum_torch(torch.tensor(means['fno_output'][4]).unsqueeze(0))
...
plt.loglog(wavenumbers, lres_interp_shum_mean, label="Bicubic Interp.", color="green", linewidth=2)
...
plt.loglog(wavenumbers, fno_shum_mean, label="FNO", color="blue", linewidth=2)
plt.fill_between(wavenumbers, fno_shum_mean - fno_shum_std, fno_shum_mean + fno_shum_std, color="blue", alpha=0.3)

# Plot VAE Output Spectrum (Specific Humidity)
plt.loglog(wavenumbers, output_shum_mean, label="Diffusion model", color="red", linewidth=2)
...
plt.loglog(wavenumbers, fno_u_mean, label="FNO", color="blue", linewidth=2)
plt.fill_between(wavenumbers, fno_u_mean - fno_u_std, fno_u_mean + fno_u_std, color="blue", alpha=0.3)

plt.loglog(wavenumbers, output_u_mean, label="Diffusion model", color="red", linewidth=2)
...
plt.grid(True, which="both", ls="--", lw=0.5)
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "spectrum_comparison_uwind.pdf"))#, dpi=300)
...
plt.loglog(wavenumbers, fno_v_mean, label="FNO", color="blue", linewidth=2)
plt.fill_between(wavenumbers, fno_v_mean - fno_v_std, fno_v_mean + fno_v_std, color="blue", alpha=0.3)

plt.loglog(wavenumbers, output_v_mean, label="Diffusion model", color="red", linewidth=2)
...
plt.grid(True, which="both", ls="--", lw=0.5)
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "spectrum_comparison_vwind.pdf"))#, dpi=300)
