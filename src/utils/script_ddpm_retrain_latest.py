...
# python -u utils/script_ddpm_retrain_latest.py --num_samples 14600

# ======================== Parse Command-Line Arguments ========================
parser = argparse.ArgumentParser(description="Generate quality metrics from retrained latest model samples.")
...
samples_dir = os.path.join(results_dir, "samples_lucie_10yr_retrain_latest")
output_dir = os.path.join(results_dir, "results_retrain_latest")
...
data_to_plot = [
    ...
    (means['output'][0], "Diffusion model (Latest Retrain)", loncoords_hres, latcoords_hres),
...
data_to_plot = [
    ...
    (means['output'][1], "Diffusion model (Latest Retrain)", loncoords_hres, latcoords_hres),
...
data_to_plot = [
    ...
    (means['output'][2], "Diffusion model (Latest Retrain)", loncoords_hres, latcoords_hres),
...
data_to_plot = [
    ...
    (means['output'][3]*1000, "Diffusion model (Latest Retrain)", loncoords_hres, latcoords_hres),
...
plt.loglog(wavenumbers, output_temp_mean, label="Diffusion model (Latest Retrain)", color="red", linewidth=2)
plt.fill_between(wavenumbers, output_temp_mean - output_temp_std, output_temp_mean + output_temp_std, color="red", alpha=0.3)
plt.title("Temperature Spectrum - Latest Retrained Model")
...
plt.loglog(wavenumbers, output_u_mean, label="Diffusion model (Latest Retrain)", color="red", linewidth=2)
plt.fill_between(wavenumbers, output_u_mean - output_u_std, output_u_mean + output_u_std, color="red", alpha=0.3)
plt.title("U-Wind Spectrum - Latest Retrained Model")
plt.xlabel("Wavenumber")
plt.ylabel("Mean Magnitude")
plt.legend()
plt.grid(True, which="both", ls="--", lw=0.5)
...
plt.loglog(wavenumbers, output_v_mean, label="Diffusion model (Latest Retrain)", color="red", linewidth=2)
plt.fill_between(wavenumbers, output_v_mean - output_v_std, output_v_mean + output_v_std, color="red", alpha=0.3)
plt.title("V-Wind Spectrum - Latest Retrained Model")
plt.xlabel("Wavenumber")
plt.ylabel("Mean Magnitude")
plt.legend()
plt.grid(True, which="both", ls="--", lw=0.5)
...
plt.loglog(wavenumbers, output_precip_mean, label="Diffusion model (Latest Retrain)", color="red", linewidth=2)
...
plt.title("Precipitation Spectrum - Latest Retrained Model")
plt.xlabel("Wavenumber")
plt.ylabel("Mean Magnitude")
plt.legend()
plt.grid(True, which="both", ls="--", lw=0.5)
