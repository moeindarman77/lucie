...
class VAE(nn.Module):
    def __init__(self, input_channels, output_channels, model_config):
        ...
        self.conv_reshape = nn.Conv2d(output_channels, output_channels, kernel_size=(8,1), stride=(1,1), padding=(0,0)) # From 728x1440 to 721x1440
    ...
    def forward(self, x, lsm=None):
        ...
        reconstructed_output = self.conv_reshape(reconstructed_output)
