...
################# This model is the same as the fno_ddpm model but with the skip connections removed
################# I am doing this because I want to see if the model can learn without the skip connections to the condition
