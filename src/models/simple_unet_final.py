...
class SimpleUnet(nn.Module):
    ...
    def __init__(self, 
                ...
                #  down_channels = (128, 192, 256, 512), 
                #  up_channels = (128, 128, 128, 128, 128), 
                 up_channels = (128, 128, 128, 128), 
                #  up_channels = (512, 256, 192, 128), 
                 time_emb_dim = 64): # Used to be 64 (for big model 512)
        ...
        # Initial projection
        self.conv0 = nn.Conv2d(in_channels+6, down_channels[0], 3, padding='same') # 3 beccause 2 hres + 1 orography
